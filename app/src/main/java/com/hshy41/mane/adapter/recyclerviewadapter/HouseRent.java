...
import com.hshy41.mane.adapter.HouseRentListViewAdapter;
...
public class HouseRent
        extends RecyclerView.Adapter<HouseRent.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
         ...
         * 周边商户整体布局
         */
        private LinearLayout ll_houserent;
        /**
         * 周边商户整体布局
         */
        ...
        public ViewHolder(ViewGroup parent, View view) {
            ...
            mView = view;
            autoviewpager = (AutoScrollViewPager) view.findViewById(R.id.avp_houserent);
            layout = (LinearLayout) view.findViewById(R.id.ll_houserent_bannarpointer);
            listview = (ListView) view.findViewById(R.id.lv_houserent);
            ...
            ll_houserent = (LinearLayout) view.findViewById(R.id.ll_zhoubianshangh);
            ...
            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    bundle.putInt("activity", Cons.ACTIVITY_HOUSERENT);
...
//            ViewSetUtils.setViewHeighWithListView(context, ll_pop, listview);
        ...
        private void setlistview() {
            // TODO Auto-generated method stub
            HouseRentListViewAdapter listViewAdapter = new HouseRentListViewAdapter(mContext);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_houserent, parent, false);
