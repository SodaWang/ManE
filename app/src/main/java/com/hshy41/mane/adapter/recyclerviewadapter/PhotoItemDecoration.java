...
public class PhotoItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public PhotoItemDecoration(Context context, int orientation) {
        mContext = context;
...
//            drawHorizontal(c, parent);
    ...
    public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
        if (mOrientation == VERTICAL_LIST) {
            outRect.set(0, 0, 0, ViewSetUtils.dp2px(mContext, 3));
        } else {
            outRect.set(0, 0, ViewSetUtils.dp2px(mContext, 3), 0);
        }
    }
}
