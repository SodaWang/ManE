...
import com.hshy41.mane.fragment.HouseRentFragment;
...
public class HouseRentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initTabLayout() {
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.tl_houserent);
...
//		tb_houserent = (Toolbar) findViewById(R.id.tb_houserent);
//		tb_houserent.setNavigationIcon(R.drawable.back);
//		tb_houserent.setTitle(R.string.aroundshop);
//		setSupportActionBar(tb_houserent);
    }

    protected void initViewPager() {
        mRecyclerView = (RecyclerViewPager) findViewById(R.id.rvp_houserent);
    ...
    private void setTitleBar() {
        ...
        tv_title_text.setText(R.string.houserent);
