...
import com.hshy41.mane.fragment.ServiceListFragment;
...
//		setSupportActionBar(tb_zhoubianshanghu);
    ...
    protected void initViewPager() {
        mRecyclerView = (RecyclerViewPager) findViewById(R.id.rvp_servicelist);
    ...
    private void setTitleBar() {
        ...
        tv_title_text.setText(R.string.cleaninglist);
