 ...
 * 公共报修单页面
 */
public class PublicRepairTableActivity extends BaseActivity implements View.OnClickListener, com.bigkoo.alertview.OnItemClickListener {
     ...
     * @return
     */
    RecyclerView rv_public_repair_table;
    ...
    protected int setContent() {
        return R.layout.activity_public_repair_table;
    }

    @Override
    protected void initViews() {
        bt_commit = (Button) findViewById(R.id.bt_public_repair_commit);
        ...
        //预设RecyclerView的各种属性
        rv_public_repair_table = (RecyclerView) findViewById(R.id.rv_public_repair_table);
        adapter = new AddPhoto(this, list_photo);
        LinearLayoutManager llm = new LinearLayoutManager(this);
        llm.setOrientation(LinearLayoutManager.HORIZONTAL);
        rv_public_repair_table.setAdapter(adapter);
        rv_public_repair_table.setLayoutManager(llm);
        rv_public_repair_table.addItemDecoration(
                new PhotoItemDecoration(this, PhotoItemDecoration.HORIZONTAL_LIST));
        rv_public_repair_table.setItemAnimator(new DefaultItemAnimator());
...
//                        int id = rv_public_repair_table.getChildPosition(view);
...
//        rv_public_repair_table.setOnTouchListener(verticalListener);
        //添加item点击监听
        adapter.setOnItemClickLitener(new AddPhoto.OnItemClickLitener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                new AlertView("上传头像", null, "取消", null,
                        ...
                        PublicRepairTableActivity.this, AlertView.Style.ActionSheet,
                        PublicRepairTableActivity.this)
                        .show();
            }
...
//                    adapter.notifyDataSetChanged();//通知视图
    ...
    protected void setTitleBar() {
        ...
        tv_title_text.setText(R.string.public_repair_table);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.bt_title_left:
                finish();
                break;
            case R.id.bt_public_repair_commit:
                finish();
                break;
        }
    }
